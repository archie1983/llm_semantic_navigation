...
class ModelType(Enum):
    ...
    AI2_THOR_SURR = 200 # For generating surrogate data using the original AI2-THOR labels and sorting them by my logic
    HYBRID_AI2_THOR = 300 # For generating hybrid data of surrogate data and original AI2-THOR labels

  ...
  def __init__(self, gen_flavour, datasets_to_gen = 1000):
    ...
    if gen_flavour == ModelType.FEATURES_12:
        ...
        (room_types[2], ['aluminumfoil', 'apple', 'blinds', 'book', 'bottle',
                         ...
                         'mug', 'pan', 'papertowelroll', 'peppershaker', 'plate',
                         'pot', 'potato', 'saltshaker', 'scrubbrush', 'shelf',
                         'sink', 'soapbar', 'soapbottle', 'spatula', 'spoon',
                         'spraybottle', 'stool', 'stoveburner', 'stoveknob',
                         'tabletopdecor', 'toaster', 'tomato', 'towel',
